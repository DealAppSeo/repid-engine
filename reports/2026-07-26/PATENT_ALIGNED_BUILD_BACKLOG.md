...
- ⚠ Items 3-10 (retrieval API, answer-binding, DDL tables, HAL abstain, ANFIS enablement/cascade/schedule-axis, EAS anchoring) show partial name-grep hits in `src/` as of 2026-08-27 but have not been verified wired the way item 20 was — do not assume done or not-done from this line, check the item.
