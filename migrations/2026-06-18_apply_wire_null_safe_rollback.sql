-- Rollback: Restore apply_repid_score_event trigger function to non-null-safe agent_id write
-- Created: 2026-06-18
...
BEGIN
  ...
  VALUES
    (v_agent_text, NULL, v_delta, COALESCE(NEW.metadata->>'tx_hash', NEW.idempotency_key, '0x_simulated'),
