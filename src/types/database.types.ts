  ...
  public: {
    Tables: {
      ...
      ai_collaboration_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_collaboration_logs_campaign_id_fkey"
            columns: ["campaign_id"]
            isOneToOne: false
      ...
      ai_flags: {
        Row: {
          ...
          status: string | null
          user_id: number | null
          user_repid_at_flag: number | null
        }
        Insert: {
          category: string
          comment?: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "ai_flags_debate_id_fkey"
            columns: ["debate_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "ai_flags_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
      ...
      ai_personalities: {
        Row: {
          ...
          ai_name: string
          best_friend_descriptors: string[] | null
          ...
          hero_inspiration: string | null
          id: string
          last_interaction: string | null
          least_favorite_activities: string | null
          mbti_type: string | null
          personality_traits: Json | null
          profiling_completeness: number | null
      ...
      ai_repid_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_repid_history_model_id_fkey"
            columns: ["model_id"]
            isOneToOne: false
          ...
          },
          {
            ...
            columns: ["model_id"]
            isOneToOne: false
            referencedRelation: "ai_models_for_sync"
            referencedColumns: ["id"]
          },
        ]
      }
      ai_reputation_scores: {
        Row: {
          ai_agent: string
          average_cost_per_acquisition: number | null
          average_user_satisfaction: number | null
          created_at: string | null
      ...
      aidebate_users: {
        Row: {
          accurate_votes: number | null
          alter_ego_avatar: string | null
          alter_ego_data: Json | null
          alter_ego_name: string | null
          avatar_url: string | null
          created_at: string | null
          daily_repid_earned: number | null
          display_name: string | null
          email: string
          expert_votes: number | null
          exploration_complete: boolean | null
          exploration_insights: Json | null
          id: number
          last_repid_reset: string | null
      ...
      aidebate_vote_aggregates: {
        Row: {
          ai_a_id: string | null
          ai_a_votes: number | null
          ai_b_id: string | null
          ai_b_votes: number | null
    ...
    Functions: {
      ...
      compute_tier: { Args: { repid: number }; Returns: string }
