...
const hal_tester_1 = require("./src/services/hal-tester");
const telegram_1 = require("./src/routes/telegram");
const db_1 = require("./src/db");
require('dotenv').config();
async function runHAEEEpoch() {
    console.log('[HAEE] Starting epoch...');
    try {
        const supabase = db_1.db;
        ...
        const prevF1 = prevMetrics?.[0]?.domain_metrics?.f1_score || 0;
        const result = await (0, hal_tester_1.runTier1Benchmark)();
        if (!result)
            return;
        ...
        await (0, telegram_1.sendTelegramAlert)(`🧠 <b>HAEE EPOCH COMPLETE</b>\n`
...
runHAEEEpoch();
//# sourceMappingURL=run_epoch.js.map